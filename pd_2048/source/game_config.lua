...
local Config = {
    ...
    SUSPEND_FORMAT_VERSION = 3,
    SUSPEND_RESTORE_STEPS_PER_FRAME = 120,
    ACHIEVEMENT_NOTIFICATION_DURATION_MS = 3000,
    SCORE_MULTIPLIER = 100,
	-- NORMALモードの初期配置.
    NORMAL_INITIAL_BLOCK_VALUE = 8,
    NORMAL_RESCUE_INITIAL_BLOCK_VALUE = 256,
	-- NORMALモードのレベル関連.
    LEVEL_DROP_XP = 1,
	...
	-- ROOTメニューの選択項目説明文の描画位置.
    TITLE_ITEM_DESCRIPTION_X = 12,
    TITLE_ITEM_DESCRIPTION_Y = 216,
    TITLE_ITEM_DESCRIPTION_WIDTH = 376,
    TITLE_ITEM_DESCRIPTION_HEIGHT = 30,
	-- PRACTICEモードの説明文の描画位置.
    TITLE_PRACTICE_DESCRIPTION_X = 12,
    TITLE_PRACTICE_DESCRIPTION_Y = 204,
